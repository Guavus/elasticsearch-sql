...
//
    ...
    public void test() throws Exception{
        String where = "select srcIp,dstIp,count(*) from blacklist7lakh where hField1 = 13 GROUP BY srcIp,dstIp";
        ...
        String dsl = searchDao.explain(where/*"SELECT * FROM index"*/).explain().explain();
        System.out.println(dsl);
        System.out.println(new SearchDao(client).explain(where/*"SELECT * FROM index"*/).explain().explain());
    }
